...
const BodyWrap = () => {
  return (
    <div className="body-wrap">
          ...
          <div className="mt-2">
            ...
            <div>
              <img
                ...
                src="./image/Products/12.jpg"
                alt="12"
              />
            </div>
            <div className="des">
              <div>BLACK CREPE FLORAL PRINT</div>
              <div className="price">350.000 vnđ</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <ProductsListContainer products={[]} />
      <div className="row menu2">
        <div className="col-lg-3 col-md-3 col-sm-3">
          <div className="menu2-left">Tất cả sản phẩm</div>
        </div>
        <div className="col-lg-9 col-md-9 col-sm-9">
          <ul className="nav menu2-right">
            <li className="nav-item">
              <div className="nav-link active-category-item" to="">
                Mây tre đan
              </div>
            </li>
            <li className="nav-item">
              <div className="nav-link" to="/categorys/may-la-tre">
                Mây lá tre
              </div>
            </li>
            <li className="nav-item">
              <div className="nav-link" to="/category/san-pham-may-la-tre">
                Sản phẩm mây tre lá
              </div>
            </li>
            <li className="nav-item">
      ...
      <div className="row menu2">
        <div className="col-lg-3 col-md-3 col-sm-3">
          <div className="menu2-left">Tin tức</div>
        </div>
        <div className="col-lg-9 col-md-9 col-sm-9">
          <ul className="nav menu2-right">
            <li className="nav-item">
      ...
      <div className="row section-3">
        <div className="col-lg-6 col-md-6 col-sm-6">
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-6 image-left">
              <img src="./image/tintuc1.png" className="image" alt="" />
            </div>
            <div className="col-lg-6 col-md-6 col-sm-6 content align-items-end">
              ...
              <div className="item-content-2 w-100">
                <div>Đông trùng hạ thảo – món quà biếu đẳng cấp của bạn</div>
              </div>
        ...
        <div className="col-lg-6 col-md-6 col-sm-6">
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-6 image-left">
              <img src="./image/tintuc2.png" className="image" alt="" />
            </div>
      ...
      <div className="row section-5">
        ...
        <img src="./image/bg.png" className="mt-3" alt="" />
      </div>
